...
1. リポジトリ名: `x-ai-auto-post`（任意）

1. 公開設定: **Public**（Freeプランの場合、GitHub Actionsを使うにはPublicが必要）
...
1. **App permissions** を **"Read and Write"** に変更
...
1. `post-tweet` ジョブをクリック

1. ログを確認して、投稿が成功したか確認
...
1. Access TokenとAccess Token Secretを**再生成**

1. GitHub Secretsを新しい値に更新
...
1. 値に余分なスペースや改行が含まれていないか確認

1. すべてのSecretが設定されているか確認
